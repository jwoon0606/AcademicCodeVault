# :credit_card: 온라인 쇼핑몰 회원 관리 프로그램
<img width="500" src="https://github.com/jwoon0606/ProgrammingStudio/assets/162769592/96f3d83f-f0ef-41fe-b7b5-2d850d043ed0">

## 1. 제작 의도
- 온라인 쇼핑몰 회원들의 정보를 관리하는 프로그램 입니다.
- 회원 등록, 수정, 삭제, 조회(CRUD)가 가능합니다.
- 회원 등급 관리가 가능합니다.
  + 회원 등급에 따라 다른 할인율이 적용됩니다.
  + 등급은 회원의 총 소비량을 기준에 따라 자동으로 적용됩니다.
- 포인트 기능이 있습니다.
  + 구매할 때마다 구매 금액의 10%씩 적립됩니다.
  + 5000 포인트 이상일 때부터 사용 가능합니다.
  + 회원 가입할 때 2000 포인트가 지급됩니다.

## 2. 제작자
| 남종운(22000220)    |
|:-----------:|
| <img src="https://github.com/jwoon0606.png" alt="프로필 이미지" width="200" height="200"> |
|[@jwoon0606](https://github.com/jwoon0606)|
